<aside class="main-sidebar sidebar-light-succes elevation-4">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
					<!--///////////////////// tampilan sisi perusahaan//////////////////// -->
					<?php if($_SESSION['bagian']=='perusahaan'){ ?>
						<a href="welcome" class="d-block"><?php echo $_SESSION['nama'] ?></a>
					</div>
				</div>
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						<li class="nav-item has-treeview menu-open">
							<a href=" <?php echo base_url()?>transaksi/transaksiPerusahaan" class="nav-link">
						...
						<li class="nav-item has-treeview menu-open">
							<a href="<?php echo base_url()?>transaksi/submitPerusahaan" class="nav-link">
								<i class="nav-icon fa fa-th"></i>
								<p>
								Pengajuan Transaksi
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item has-treeview menu-open">
							<a href=" <?php echo base_url()?>nasabah/listPerusahaan" class="nav-link">
								<i class="nav-icon fa fa-th"></i>
								<p>
								Kelola Perusahaan
								</p>
