...
<body>
          ...
          <div class="row h-100 align-items-center">
            <div class="col-8">
              <div class="welcome-content">
                ...
                <span style="color: #ffffff; font-size: xx-large "> Bank Sampah Desa untuk mengubah sampah menjadi
                  sesuatu
                  yang berguna di
                  masyarakat, dan bernilai ekonomis </span>
                <h1 style="color: #ffffff;"><span class="typed-words"></span></h1>

                <a href="#" class="btn famie-btn mt-4" data-animation="bounceInUp" data-delay="600ms">Gabung</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="100ms">
            ...
            <h5>Praktis</h5>
            <span>Pengelolaan data dilakukan secara digital & dapat meningkatkan paperless activity </span>
          </div>
        </div>
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="500ms">
            ...
            <h5>Transparan</h5>
            <span>Pengelola Bank Sampah dapat mengelola tabungan nasabah secara transparan</span>
          </div>
        </div>
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="900ms">
            ...
            <h5>Ekonomis</h5>
            <span>Memberikan manfaat ekonomis dan mengurangi sampah dirumah</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-8">
          <div class="about-us-content mb-100">
            ...
            <p>Bank Sampah Malang (BSM) adalah suatu lembaga yang berbadan hukum koperasi yang 
            pendiriannya difasilitasi oleh Pemerintah Kota Malang melalui Dinas Kebersihan dan
            Pertamanan untuk membantu dalam hal pemberdayaan masyarakat untuk ikut serta aktif 
            dalam pengolahan sampah dari sumbernya (rumah tangga). Seiring perjalanan waktu BSM 
            menjadi mitra Kota Malang dalam hal membina, melatih, mendampingi dalam pengolahan 
            sampah 3R (reduce, reuse and recycle) masyarakat Kota Malang yang mandiri dilihat 
            dari biaya operasional yang dapat dibiayai sendiri.</p>
            <a href="about.php" class="btn famie-btn mt-30">Read More</a>
          </div>
        </div>
  ...
  <script>
    var typed = new Typed('.typed-words', {
      strings: [" Ubah Sampah", " Jadi Berkah",],
      typeSpeed: 80,
      backSpeed: 80,
      backDelay: 2000,
      startDelay: 80,
